...
public class FileDataHandler
{
    ...
    public GameData Load(string profileId, bool allowRestoreFromBackup = true)
    {
        ...
        //instead of dataDirPath + "/" + dataFileName, use Path.Combine to account for different OS's having different path separators
    ...
    public string GetMostRecentlyUpdatedProfileId()
    {
        ...
        Dictionary<string, GameData> profilesGameData = LoadAllProfiles(); foreach (KeyValuePair<string, GameData> pair in profilesGameData) 
        {
